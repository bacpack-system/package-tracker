...
SET(MOCK_CMLIB_STORAGE_TEMPLATE_INSTANCE_GIT_PATH ""
    CACHE INTERNAL
    "Captured GIT_PATH argument"
)
SET(MOCK_CMLIB_STORAGE_TEMPLATE_INSTANCE_REVISION ""
    CACHE INTERNAL
    "Captured REVISION argument"
)
SET(MOCK_CMLIB_STORAGE_TEMPLATE_INSTANCE_PACKAGE_GROUP_NAME ""
    CACHE INTERNAL
    "Captured PACKAGE_GROUP_NAME argument"
)
SET(MOCK_CMLIB_STORAGE_TEMPLATE_INSTANCE_TEMPLATE_VALUE ""
    CACHE INTERNAL
    "Captured template string value (dereferenced from template variable name)"
)
...
FUNCTION(CMLIB_STORAGE_TEMPLATE_INSTANCE output_var template_var_name)
    ...
    SET_PROPERTY(CACHE MOCK_CMLIB_STORAGE_TEMPLATE_INSTANCE_TEMPLATE_VALUE PROPERTY VALUE "${${template_var_name}}")
    ...
    ENDIF()
    IF(__GIT_PATH)
        SET_PROPERTY(CACHE MOCK_CMLIB_STORAGE_TEMPLATE_INSTANCE_GIT_PATH PROPERTY VALUE "${__GIT_PATH}")
    ENDIF()
    IF(__REVISION)
        SET_PROPERTY(CACHE MOCK_CMLIB_STORAGE_TEMPLATE_INSTANCE_REVISION PROPERTY VALUE "${__REVISION}")
    ENDIF()
    IF(__PACKAGE_GROUP_NAME)
        SET_PROPERTY(CACHE MOCK_CMLIB_STORAGE_TEMPLATE_INSTANCE_PACKAGE_GROUP_NAME PROPERTY VALUE "${__PACKAGE_GROUP_NAME}")
    ENDIF()
